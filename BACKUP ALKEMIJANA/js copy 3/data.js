...
let SERVICES = [
  { id: "s1", icon: "☽", name: "Tarot Čitanje",         desc: "Otkrijte poruke koje karte nose o vašoj prošlosti, sadašnjosti i budućnosti.", price: "40", duration: "60", home: true,  archived: false },
  { id: "s2", icon: "☉", name: "Natalna Karta",          desc: "Detaljna analiza vaše astrološke karte rođenja i životnog puta.",             price: "60", duration: "90", home: true,  archived: false },
  { id: "s3", icon: "✦", name: "Duhovno Savjetovanje",   desc: "Vodstvo kroz životne prijelaze, odluke i osobni razvoj.",                     price: "50", duration: "60", home: true,  archived: false },
  { id: "s4", icon: "♆", name: "Tranziti & Predviđanja", desc: "Astrološka analiza nadolazećeg razdoblja i ključnih tranzita.",              price: "55", duration: "75", home: false, archived: false },
  { id: "s5", icon: "♥", name: "Ljubavna Sinastrija",    desc: "Usporedba dvije natalne karte i analiza odnosa.",                            price: "75", duration: "90", home: false, archived: false },
  { id: "s6", icon: "☿", name: "Online Konzultacija",    desc: "Sve usluge dostupne putem video poziva, bilo gdje u svijetu.",               price: "35", duration: "60", home: false, archived: false }
];
