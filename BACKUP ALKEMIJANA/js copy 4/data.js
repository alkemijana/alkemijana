...
let SERVICES = [
  { id: "s1", icon: "✧", name: "Poruke svemira",          desc: "Opće tarot čitanje u kojem ti donosiš temu, a karte donose odgovore. Zajedno istražujemo što ti svemir želi reći upravo sada.",                                                                                    price: "40", duration: "45", home: true,  archived: false },
  { id: "s2", icon: "♡", name: "Tajne srca",              desc: "Čitanje uz tarot i oracle karte fokusirano na ljubav - što te blokira, tko je tvoj idealni partner i što ti srce već zna, a um još ne prihvaća.",                                                                   price: "60", duration: "60", home: true,  archived: false },
  { id: "s3", icon: "✦", name: "Razgovor s nesvjesnim",   desc: "Asocijativne karte su projektivna psihoterapijska tehnika koja nema veze s ezoterijom - one su alat za razgovor s vlastitim nesvjesnim. Sve što ti treba već je u tebi.",                                             price: "50", duration: "60", home: true,  archived: false },
  { id: "s4", icon: "☽", name: "Povratak sebi",           desc: "Najdublja i najpospežnija usluga. Uz tarot, visak, astrologiju i asocijativne karte zajedno istražujemo tvoje obrasce, kako ti prošlost oblikuje sadašnjost i što ti treba da doneseš bolje odluke za sebe.",         price: "55", duration: "75", home: false, archived: false },
  { id: "s5", icon: "☉", name: "Tren jasnoće",            desc: "Jedno konkretno pitanje, jedan jasan odgovor. Pošalješ mi pitanje, ja radim čitanje viskom i šaljem ti video odgovor - direktno na WhatsApp.",                                                                       price: "75", duration: "90", home: false, archived: false },
  { id: "s6", icon: "⊹", name: "Na raskrižju",            desc: "Stojite pred izborom i ne znate kuda? Uz tarot i arhetipske karte zajedno rasvijetlimo obje strane i ono što se krije iza svake odluke.",                                                                            price: "35", duration: "60", home: false, archived: false }
];
...
let PRICING = [
  { name: "Brzo Čitanje",        desc: "Jedno pitanje, 3 karte, 20 minuta",           price: "20", archived: false },
  { name: "Tarot Čitanje",       desc: "Klasično čitanje, 60 minuta",                 price: "40", archived: false },
  { name: "Duhovno Savjetovanje",desc: "Razgovor uz karte, 60 minuta",                price: "50", archived: false },
  { name: "Tranziti",            desc: "Astrološka analiza razdoblja, 75 minuta",     price: "55", archived: false },
  { name: "Natalna Karta",       desc: "Karta rođenja + pisani izvještaj, 90 minuta", price: "60", archived: false },
  { name: "Ljubavna Sinastrija", desc: "Analiza odnosa dvije karte, 90 minuta",       price: "75", archived: false },
  { name: "Solarni Povratak",    desc: "Godišnja prognoza, 60 minuta",                price: "45", archived: false }
];
