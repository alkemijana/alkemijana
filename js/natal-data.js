...
const GLYPHS = {
  ...
  aries:       { s:'M12,21 L12,8 M12,8 C12,4.5 10,2.6 7.2,2.6 C4.5,2.6 2.9,4.6 2.9,7.1 C2.9,9.1 4,10.5 5.9,11.1 M12,8 C12,4.5 14,2.6 16.8,2.6 C19.5,2.6 21.1,4.6 21.1,7.1 C21.1,9.1 20,10.5 18.1,11.1' },
  taurus:      { s:'M12,9.6 A5.7,5.7 0 1,0 12,21 A5.7,5.7 0 1,0 12,9.6 M4.4,2.8 A7.7,7 0 0,0 19.6,2.8' },
  gemini:      { s:'M8.8,5.4 L8.8,18.6 M15.2,5.4 L15.2,18.6 M4.4,3.4 C8.7,6 15.3,6 19.6,3.4 M4.4,20.6 C8.7,18 15.3,18 19.6,20.6' },
  cancer:      { s:'M20.2,7.8 C17.6,4.7 12,3.8 8.3,5.9 M8.5,5.8 A3.05,3.05 0 1,0 8.5,11.9 A3.05,3.05 0 1,0 8.5,5.8 M3.8,16.2 C6.4,19.3 12,20.2 15.7,18.1 M15.5,18.2 A3.05,3.05 0 1,0 15.5,12.1 A3.05,3.05 0 1,0 15.5,18.2' },
  leo:         { s:'M10.2,17.4 C10.2,14.3 8.7,12.4 8.7,9.2 C8.7,5.5 10.9,3 13.9,3 C16.7,3 18.5,5.1 18.5,7.8 C18.5,10.7 16.3,13.3 16.3,16.3 C16.3,18.5 17.8,19.5 19.6,18.5 M7.3,14.9 A3.05,3.05 0 1,0 7.3,21 A3.05,3.05 0 1,0 7.3,14.9' },
  ...
  pisces:      { s:'M8.4,3 C5.5,6.7 5.5,17.3 8.4,21 M15.6,3 C18.5,6.7 18.5,17.3 15.6,21 M6.3,12 L17.7,12' },
