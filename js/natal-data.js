...
const GLYPHS = {
  ...
  aries:       { s:'M12,21 L12,10.5 M12,10.5 C12,6 9,2.8 5.4,2.8 C3.5,2.8 2.4,4.4 3,6.4 M12,10.5 C12,6 15,2.8 18.6,2.8 C20.5,2.8 21.6,4.4 21,6.4' },
  taurus:      { s:'M12,10 A5.6,5.6 0 1,0 12,21.2 A5.6,5.6 0 1,0 12,10 M2.8,5.6 C3,3.7 4.6,3.6 5.2,5.5 C6.2,8.5 9,10.4 12,10.4 C15,10.4 17.8,8.5 18.8,5.5 C19.4,3.6 21,3.7 21.2,5.6' },
  gemini:      { s:'M8.8,5.4 L8.8,18.6 M15.2,5.4 L15.2,18.6 M4.4,3.4 C8.7,6 15.3,6 19.6,3.4 M4.4,20.6 C8.7,18 15.3,18 19.6,20.6' },
  cancer:      { s:'M19.6,8 C16.6,5 11.4,5 8.2,7.3 M7.9,6.9 A2.4,2.4 0 1,0 7.9,11.7 A2.4,2.4 0 1,0 7.9,6.9 M4.4,16 C7.4,19 12.6,19 15.8,16.7 M16.1,12.3 A2.4,2.4 0 1,0 16.1,17.1 A2.4,2.4 0 1,0 16.1,12.3' },
  leo:         { s:'M10.2,17.2 C10.2,14.1 8.7,12.2 8.7,9 C8.7,5.3 10.9,2.8 13.9,2.8 C16.7,2.8 18.5,4.9 18.5,7.6 C18.5,10.5 16.3,13.1 16.3,16.1 C16.3,18.6 18,20 20,19.2 M7.3,15.4 A3.05,3.05 0 1,0 7.3,21.5 A3.05,3.05 0 1,0 7.3,15.4' },
  virgo:       { s:'M3.5,16.8 L3.5,9.6 A2.45,2.45 0 0,1 8.4,9.6 L8.4,16.8 M8.4,9.6 A2.45,2.45 0 0,1 13.3,9.6 L13.3,15 C13.3,18.6 16.8,19.4 18.5,16.9 C19.7,15.1 18.7,12.8 16.6,13.3 C15.1,13.7 14.9,15.7 16.4,16.8' },
  libra:       { s:'M4,19.2 L20,19.2 M4,14.8 L8.2,14.8 M15.8,14.8 L20,14.8 M8.2,14.8 A4,4 0 1,1 15.8,14.8' },
  ...
  capricorn:   { s:'M3,7 L6.6,13 L9.6,7 C10.6,5 13.6,5.3 14.6,7.6 C15.3,9.1 14.7,11.1 15.1,13.1 C15.5,15.5 17.9,16.1 19.3,14.1 C20.4,12.5 19.4,10.4 17.5,10.9 C16.1,11.3 15.8,13.1 17.1,14.1' },
  aquarius:    { s:'M2.8,9 L5.9,6 L8.9,9 L12,6 L15.1,9 L18.1,6 L21.2,9 M2.8,15.6 L5.9,12.6 L8.9,15.6 L12,12.6 L15.1,15.6 L18.1,12.6 L21.2,15.6' },
  pisces:      { s:'M8,3 C11.2,6.8 11.2,17.2 8,21 M16,3 C12.8,6.8 12.8,17.2 16,21 M6.3,12 L17.7,12' },
